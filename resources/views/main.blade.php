                            ...
                            <ul class="nav-users push">
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="{{ asset('codebase/assets/media/avatars/avatar5.jpg') }}" alt="">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="{{ asset('codebase/assets/media/avatars/avatar10.jpg') }}" alt="">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="{{ asset('codebase/assets/media/avatars/avatar7.jpg') }}" alt="">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu min-width-300" aria-labelledby="page-header-options-dropdown">
                                ...
                                <div class="row no-gutters text-center mb-5">
                                    ...
                                    <div class="col-2 mb-5">
                                        <a class="text-elegance" data-toggle="theme" data-theme="{{ asset('codebase/assets/css/themes/elegance.min.css') }}" href="javascript:void(0)">
                                            <i class="fa fa-2x fa-circle"></i>
                                        </a>
                                    </div>
                                    <div class="col-2 mb-5">
                                        <a class="text-pulse" data-toggle="theme" data-theme="{{ asset('codebase/assets/css/themes/pulse.min.css') }}" href="javascript:void(0)">
                                            <i class="fa fa-2x fa-circle"></i>
                                        </a>
                                    </div>
                                    <div class="col-2 mb-5">
                                        <a class="text-flat" data-toggle="theme" data-theme="{{ asset('codebase/assets/css/themes/flat.min.css') }}" href="javascript:void(0)">
                                            <i class="fa fa-2x fa-circle"></i>
                                        </a>
                                    </div>
                                    <div class="col-2 mb-5">
                                        <a class="text-corporate" data-toggle="theme" data-theme="{{ asset('codebase/assets/css/themes/corporate.min.css') }}" href="javascript:void(0)">
                                            <i class="fa fa-2x fa-circle"></i>
                                        </a>
                                    </div>
                                    <div class="col-2 mb-5">
                                        <a class="text-earth" data-toggle="theme" data-theme="{{ asset('codebase/assets/css/themes/earth.min.css') }}" href="javascript:void(0)">
                                            <i class="fa fa-2x fa-circle"></i>
                                        </a>
                                    </div>
                                </div>
